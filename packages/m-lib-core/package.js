...
Package.onUse(function(api) {
  ...
  var packages = [
    ...
    'tracker',
    'session',
    'blaze@=2.1.9', //2.2.0 breaks autoform completely
    ...
    'simple:reactive-method@1.0.0',
    'percolate:synced-cron@1.0.0',
  ...
  api.use('ecmascript');
  api.use('meteor-base');
  api.use('percolate:synced-cron@1.0.0');
