...
SimpleSchema.messages({
  ...
  sureIcinZamanYok: 'Sınav açılış ve kapanış zaman aralığı bu süre için yetersiz',
  yanitlarSonraOlmali: 'Yanıt açılış zamanı sınav kapanış zamanından sonra olmalı',
  ...
  sorusuzSinavTaslakKalmali: 'Soru eklenmemiş bir sınavın taslak işaretini kaldıramazsınız',
  sorusuzSinavKilitsizKalmali: 'Soru eklenmemiş bir sınavı kilitleyemezsiniz',
  taslakSoruKilitlenemez: 'Taslak haldeki bir soruyu kilitleyemezsiniz',
  taslakSinavKilitlenemez: 'Taslak haldeki bir sınavı kilitleyemezsiniz',
  sinavdakiSoruTaslakYapilamaz: 'Bu soru bir sınava eklenmiş, taslak olarak işaretleyemezsiniz',
